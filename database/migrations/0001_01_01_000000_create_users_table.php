...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('ui_theme', 20)->default('nexo');
            $table->string('ui_mode', 10)->default('dark');
            $table->string('ui_locale', 10)->default('es');
            $table->enum('role', ['admin', 'seller', 'buyer'])->default('buyer');
            $table->string('provider')->nullable(); // google, steam
